...
function architecture() {
	...
	request.onload = function () {   // Begin accessing JSON data here
		...
		for (let page of data.items) {
			...
			let catidtext;
			if (n == 2) {
                $('#architecture1').append(`

                <div class="col-md-12">
                <div class="blog-box">
                    <div class="post-media">
                        <div class="post-media">
                            <a href="single-video.html?ref=Architecture&id=${page.id.videoId}"
                                title="">
                    ...
                    <div class="blog-meta big-meta">
                        <h4><a href="single.html" title="">How To Vlog | How To Be A
                                Vlogger!</a></h4>
                        <p>${title}</p>
                        <small><a href="architecture.html" title="">Architecture</a></small>
                        <small><a href="single.html" title="">${datestr}</a></small>
                        <small><a href="blog-author.html" title="">by Ashley Nichole</a></small>
                    </div><!-- end meta -->
                    <a href="single-video.html?ref=Architecture&id=${page.id.videoId}" class="btn btn-primary">Read More</a>
                </div><!-- end blog-box -->
            </div><!-- end col -->
